...
namespace PolaFigur
{
    class Program
    {
        ...
        private static void CalculateTriangleField()
        {
        ...
        private static void CalculateRectangleField()
        {
        ...
        private static void CalculateSquareField()
        {
        ...
        private static void CalculateCircleField()
        {
